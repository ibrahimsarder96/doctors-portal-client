      ...
      <input type="checkbox" id="booking-modal" className="modal-toggle" />
        <div className="modal modal-bottom sm:modal-middle">
          ...
          <label for="booking-modal" className="btn btn-accent btn-circle absolute right-2 top-2">✕</label>
            ...
            <input type="text" name="name" placeholder="Your name" className="input input-bordered w-full max-w-xs border-accent text-accent text-lg"/>
            <input type="email" name="email" placeholder="Email address" className="input input-bordered w-full max-w-xs border-accent text-accent text-lg"/>
